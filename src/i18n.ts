...
const translations = {
  en: {
    ...
    geminiKeyDesc: "Used for README summaries via Google Gemini (shared across all profiles)",
    geminiKeyPlaceholder: "AIza...",
    geminiModel: "Model",
    geminiModelDesc: "Gemini model to use for summaries",
    openaiKey: "OpenAI API key",
    openaiKeyDesc: "Used for README summaries via OpenAI (shared across all profiles)",
    openaiKeyPlaceholder: "sk-...",
    openaiModel: "Model",
    openaiModelDesc: "OpenAI model to use for summaries",
  ...
  ja: {
    ...
    geminiKey: "Google Gemini API キー",
    geminiKeyDesc: "README要約に使用（全プロファイル共通）",
    geminiKeyPlaceholder: "AIza...",
    geminiModel: "モデル",
    geminiModelDesc: "要約に使用する Gemini モデル",
    openaiKey: "OpenAI API キー",
    openaiKeyDesc: "README要約に使用（全プロファイル共通）",
    openaiKeyPlaceholder: "sk-...",
    openaiModel: "モデル",
    openaiModelDesc: "要約に使用する OpenAI モデル",
